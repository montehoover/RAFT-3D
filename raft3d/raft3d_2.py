...
class RAFT3D(nn.Module):
    ...
    def forward(self, image1_1, image2_1, depth1_1, depth2_1, intrinsics_1, 
    image1_2, image2_2, depth1_2, depth2_2, intrinsics_2, iters=12, train_mode=False):
        """ Estimate optical flow between pair of frames """

        Ts_1, coords0_1 = self.initializer(image1_1)
        Ts_2, coords0_2 = self.initializer(image1_2)

        corr_fn_1, net_1, inp_1 = self.features_and_correlation(image1_1, image2_1)
        corr_fn_2, net_2, inp_2 = self.features_and_correlation(image1_2, image2_2)


        # intrinsics and depth at 1/8 resolution
        intrinsics_r8_1 = intrinsics_1 / 8.0
        depth1_r8_1 = depth1_1[:,3::8,3::8]
        depth2_r8_1 = depth2_1[:,3::8,3::8]
        intrinsics_r8_2 = intrinsics_2 / 8.0
        depth1_r8_2 = depth1_2[:,3::8,3::8]
        depth2_r8_2 = depth2_2[:,3::8,3::8]
